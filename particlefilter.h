...
struct uniform_resampler{
	...
	std::vector<unsigned int> resamplePositionalIndexes(const std::vector<Particle> & particles, int nparticles=0) const;
...
std::vector<unsigned int> uniform_resampler<Particle, Numeric>:: resampleIndexes(const std::vector<Particle>& particles, int nparticles) const{
	...
	n=0;
	unsigned int i=0;
	std::cout <<"resampling procedure " << " interval is  " << interval  << " target is " << target << std::endl;
...
template <class Particle, class Numeric>
std::vector<unsigned int> uniform_resampler<Particle, Numeric>:: resamplePositionalIndexes(const std::vector<Particle>& particles, int nparticles) const{
	Numeric cweight=0;
